/* ============================================================
   BUFFALOS BARBERSHOP — JavaScript
   👉 WhatsApp configurado: 5491173611574 (verificar con el local:
      es el teléfono publicado 011 7361-1574 en formato internacional).
   ============================================================ */
...
function mpDemo() {
  ...
  t.id = 'mp-demo-toast';
  t.innerHTML = '<strong>🔒 Demo de pago</strong><br>En el sitio real, este botón abre el checkout seguro de <b>Mercado Pago</b> para señar el turno (tarjeta, débito o dinero en cuenta).';
  Object.assign(t.style, {
    position: 'fixed', left: '50%', bottom: '28px', transform: 'translateX(-50%)',
    maxWidth: '360px', background: '#fff', color: '#121110',
